...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen p-12">
      ...
      <Tabs defaultValue="filter" className="w-[100%]" value={searchType} onValueChange={(val) => setSearchType(val)}>
        <TabsList className="w-[100%]">
          <TabsTrigger value="filter" className="tab-button">Filter Search</TabsTrigger>
